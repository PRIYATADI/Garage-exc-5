...
namespace GarageProject.Vehicles
{
    public class Bus : Vehicle
    {
        ...
        public Bus(int id, string fName, string lName, string registrationNumber, string color, string type, 
            string model, int numberOfWheels, int numberOfSeats, int numberOfEngines, DateTime parkingTime,
            DateTime unparkTime, float parkingPeriod, int numberOfDoubleSeats, float height) :
